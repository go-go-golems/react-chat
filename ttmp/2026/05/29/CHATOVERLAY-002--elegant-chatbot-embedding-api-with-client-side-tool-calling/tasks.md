...
- [x] T6.6: Move the mock-engine bridge into Pinocchio/Geppetto with a real frontend tool executor.
  ...
  - [x] T6.6c: Wire a real provider-backed runtime to use the bridge in an end-to-end non-mock smoke.
